...
process.on("unhandledRejection", () => {
    console.log("Unhandled Rejection detected... signal recieved... Server is sutting down..");
    if (server) {
        server.close(() => {
            process.exit(1);
        });
...
process.on("uncaughtException", () => {
    console.log("Unhandled Exception detected... signal recieved... Server is sutting down..");
    if (server) {
        server.close(() => {
            process.exit(1);
        });
