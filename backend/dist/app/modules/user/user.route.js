...
router.post("/register", (0, validatedRequest_1.validatedRequest)(user_validation_1.createUserZodSchema), user_controller_1.UserControllers.createUser);
...
router.patch("/:id", (0, validatedRequest_1.validatedRequest)(user_validation_1.updateUserZodSchema), (0, checkAuth_1.checkAuth)(...Object.values(user_interface_1.Role)), user_controller_1.UserControllers.updateUser);
